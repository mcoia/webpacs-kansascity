function updateinnReachButton() {
	...
	$(document).ready(function () {
		...
		innReachButton = "<a id='innReachLink' href=''><span title='Search for items held by libraries throughout the entire MOBIUS system.' id='parkInnReach' class='resourceButton'><img src='/screens/mobiusLibrarysearch.gif' alt=''></span></a>";
	        
	    if($(".browseScreen")[0]) {

	        $("#worldCatBut").parent().before(innReachButton); // drop a button that doesn't go anywhere
	        ...
	        $("#worldCatBut").parent().after(innReachButton); 
